...
export const POST_LISTING_REQUEST = 'CLOSE_LISTING_REQUEST';
export const POST_LISTING_FAILURE = 'CLOSE_LISTING_FAILURE';
export const POST_LISTING_SUCCESS = 'CLOSE_LISTING_SUCCESS';

export const CLOSE_LISTING_REQUEST = 'POST_LISTING_REQUEST';
export const CLOSE_LISTING_FAILURE = 'POST_LISTING_FAILURE';
export const CLOSE_LISTING_SUCCESS = 'POST_LISTING_SUCCESS';
