    ...
    render() {
        ...
        return (
            <Modal trigger={this.props.trigger}>
                ...
                <Modal.Actions>
                    {(this.props.user_id && (this.props.user_id != this.props.listing.author_pk)) && <MessageModal trigger={<Button color='teal' icon='mail outline' labelPosition='right' content='Contact Seller' listing={this.props.listing}/>}/>}
                  </Modal.Actions>
              </Modal>
        );
    }
